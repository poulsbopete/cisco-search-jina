...
export const SLIDES: Slide[] = [
  ...
  },
  {
    ...
    bullets: [
      "Talos — threat intelligence search over high-volume security telemetry.",
      "ThousandEyes — network observability on Elastic, including GovCloud options.",
      "SD-WAN / Viptela in production · Hypershield AI search & ranking · ASIG agentic security workflows.",
      "Splunk Observability — open-source Elasticsearch today; move to supported Elastic when you need Enterprise features and managed ops.",
      "Same pattern fits Meraki, Duo, Umbrella, AppDynamics, XDR, and Catalyst Center telemetry.",
    ],
  ...
  },
  {
    ...
    subtitle: "Same Elasticsearch APIs. Self-hosted, Hosted, Serverless, GovCloud Hosted.",
