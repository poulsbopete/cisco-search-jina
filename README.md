...
Each invite seeds `cisco-jina-corpus`, five dashboards (with markdown talking-point strips), and the **Dashboard notes** workflow (every 10 minutes) into that learner’s Serverless Kibana. Edit assets under `instruqt/cisco-search-jina/workshop-assets/`, then regenerate setup and push.
## App
