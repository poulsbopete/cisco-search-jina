...
Each invite seeds `cisco-jina-corpus`, five dashboards (with markdown talking-point strips), the **Dashboard notes** workflow (every 10 minutes), and ML job **`cisco-jina-circuit-tokens`** into that learner’s Serverless Kibana. Edit assets under `instruqt/cisco-search-jina/workshop-assets/`, then regenerate setup and push.
## App
